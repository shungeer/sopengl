...
//		camera.KeybordMove(Camera::FORWARD, gDeltaTime);
//	else if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS)
//		camera.KeybordMove(Camera::BACKWARD, gDeltaTime);
//	else if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS)
//		camera.KeybordMove(Camera::LEFT, gDeltaTime);
//	else if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS)
//		camera.KeybordMove(Camera::RIGHT, gDeltaTime);
...
//void BuildShader()
//{
//	gShaders[0] = new CGLMShader("shaders/lamp.vs", "shaders/lamp.fs");
//	gShaders[1] = new CGLMShader("shaders/lights.vs", "shaders/lights.fs");
//}
//// 创建所有渲染模型
//void BuildModel()
//{
...
//	glm::mat4 view;
//	glm::mat4 model;
//	projection = glm::perspective(camera._fZoom, (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
...
//	// 定向光参数
//	gShaders[1]->setVecf3("dirLight.direction", 0.2f, 2.0f, -0.3f);
...
//	gShaders[1]->setFloat("spotLight.cutOff", cos(glm::radians(12.5f)));
//	gShaders[1]->setFloat("spotLight.outCutOff", cos(glm::radians(25.0f)));
//
